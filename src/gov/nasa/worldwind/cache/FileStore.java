...
/**
 * @author Tom Gaskins
 * @version $Id: FileStore.java 13837 2010-09-20 20:25:59Z tgaskins $
 */
public interface FileStore extends WWObject
{
    ...
    /**
     * Requests a file. If the file is in the cache it is returned, otherwise it is requested and null is returned.
     *
     * @param address the file address, either a URL or a path relative to the root of the file store.
     *
     * @return the file if it is in the cache, otherwise null.
     *
