 ...
 * @version $Id: BasicMemoryCache.java 14071 2010-11-04 20:23:56Z tgaskins $
 */
...
//        this.makeSpace(this.capacity - newCapacity);
    ...
    public boolean add(Object key, Object clientObject, long clientObjectSize)
    {
        ...
        if (key == null || clientObject == null || clientObjectSize <= 0 || clientObjectSize > cap)
        {
            ...
            if (clientObjectSize > this.capacity.get())
     ...
     */
    private void removeEntry(CacheEntry entry) // MUST BE CALLED WITHIN SYNCHRONIZED
    {
