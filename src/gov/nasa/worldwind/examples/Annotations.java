        ...
        private void updateAnnotation()
        {
            if (this.currentAnnotation != null && !this.suspendUpdate)
            {
                ...
                switch (cbShape.getSelectedIndex())
                {
                    case 0:
                    {
                        this.currentAnnotation.getAttributes().setFrameShape(FrameFactory.SHAPE_RECTANGLE);
                        break;
                    }
                    case 1:
                    {
                        this.currentAnnotation.getAttributes().setFrameShape(FrameFactory.SHAPE_ELLIPSE);
                        break;
                    }
                    case 2:
                    {
                        this.currentAnnotation.getAttributes().setFrameShape(FrameFactory.SHAPE_NONE);
                        break;
                    }
                }
                switch (cbLeader.getSelectedIndex())
                {
                    case 0:
                    {
                        this.currentAnnotation.getAttributes().setLeader(FrameFactory.LEADER_TRIANGLE);
                        break;
                    }
                    case 1:
                    {
                        this.currentAnnotation.getAttributes().setLeader(FrameFactory.LEADER_NONE);
                        break;
                    }
                }
