 ...
 *
 * @author dcollins
 * @version $Id: KeepingObjectsInView.java 13909 2010-09-30 06:33:58Z pabercrombie $
 */
public class KeepingObjectsInView extends ApplicationTemplate
{
    ...
    public static Iterable<?> createObjectsToTrack()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            WWIcon icon = new UserFacingIcon("images/antenna.png", new Position(randLocation1, 0));
