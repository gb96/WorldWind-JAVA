 ...
 *
 * @author pabercrombie
 * @version $Id: ExportKML.java 13932 2010-10-04 23:22:51Z pabercrombie $
 */
public class ExportKML
{
    ...
    public static void main(String[] args)
    {
        try
        {
            ...
            // Validate document. If the document is valid, print it to System.out
            if (validateDocument(xmlString))
            {
    ...
    public static boolean validateDocument(String doc)
    {
        try
        {
