 ...
 *
 * @author tag
 * @version $Id: Placemarks.java 13852 2010-09-22 02:37:40Z tgaskins $
 */
public class Placemarks extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        public AppFrame()
        {
            ...
            pp.setValue(AVKey.DISPLAY_NAME, "Clamp to ground, Label, Audio icon");
            pp.setLineEnabled(false);
            pp.setAltitudeMode(WorldWind.CLAMP_TO_GROUND);
            PointPlacemarkAttributes attrs = new PointPlacemarkAttributes();
            attrs.setImageAddress("images/audioicon-64.png");
            attrs.setScale(0.6);
