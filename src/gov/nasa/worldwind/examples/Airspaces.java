...
/**
 * @author dcollins
 * @version $Id: Airspaces.java 13950 2010-10-07 17:40:47Z dcollins $
 */
public class Airspaces extends ApplicationTemplate
{
    ...
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected void makeComponents()
        {
            ...
            JPanel panel = new JPanel(new BorderLayout());
            {
                ...
                {
                    JCheckBox cb = new JCheckBox("Antialias", this.controller.aglAirspaces.isEnableAntialiasing());
                    cb.setActionCommand(ACTION_COMMAND_ANTIALIAS);
                    cb.addActionListener(this.controller);
                    box.add(cb);

                    cb = new JCheckBox("Fix Z-Fighting", this.controller.aglAirspaces.isEnableDepthOffset());
                    cb.setActionCommand(ACTION_COMMAND_DEPTH_OFFSET);
                    cb.addActionListener(this.controller);
                    box.add(cb);

                    cb = new JCheckBox("Show Wireframe", this.controller.aglAirspaces.isDrawWireframe());
                    cb.setActionCommand(ACTION_COMMAND_DRAW_WIREFRAME);
                    cb.addActionListener(this.controller);
                    box.add(cb);

                    cb = new JCheckBox("Show Bounds", this.controller.aglAirspaces.isDrawExtents());
    ...
    public static class AirspacesController implements ActionListener
    {
        ...
        protected Airspaces.AppFrame frame;
        // World Wind stuff.
        ...
        protected Airspace lastToolTip;
        ...
        public AirspacesController(WorldWindowGLCanvas wwd)
        {
            ...
            this.annotationLayer.setName("Airspace Annotations");
            insertBeforePlacenames(this.wwd, this.aglAirspaces);
            insertBeforePlacenames(this.wwd, this.amslAirspaces);
        ...
        public void initializeSelectionMonitoring()
        {
            ...
            this.wwd.addSelectListener(new SelectListener()
            {
                public void selected(SelectEvent event)
                {
                    ...
                    {
                        if (AirspacesController.this.showToolTip(event.getTopObject(), event))
                            AirspacesController.this.wwd.redraw();
                    }
        ...
        protected boolean showToolTip(Object o, SelectEvent e)
        {
            ...
            {
                this.annotationLayer.removeAnnotation(this.lastAnnotation);
                this.lastToolTip = null;
            }

            if (this.lastToolTip == null && o instanceof Airspace)
            {
                this.lastToolTip = (Airspace) o;
                this.lastAnnotation = this.createToolTip((Airspace) o, e);
        ...
        public void doLoadDemoAirspaces()
        {
            ...
            track.addLeg(LatLon.fromDegrees(31.5107, -88.5723), LatLon.fromDegrees(34.2444, -87.4563), minAlt / 6,
                maxAlt / 6, leftWwidth, rightWidth).setTerrainConforming(true, true);
