...
/**
 * @author tag
 * @version $Id: DraggingShapes.java 13665 2010-08-27 19:36:33Z dcollins $
 */
public class DraggingShapes extends ApplicationTemplate
{
    private static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        protected RenderableLayer buildShapesLayer()
        {
            ...
            shape = new SurfacePolyline(new ArrayList<LatLon>());
            this.setupLine(shape, layer, Color.YELLOW, true);

            return layer;
        }

        protected void setupFilledShape(AbstractSurfaceShape shape, RenderableLayer layer, Color color)
        {
        ...
        protected void setupTexturedShape(AbstractSurfaceShape shape, RenderableLayer layer, Color color,
            Object imageSource)
        {
            ShapeAttributes attributes = new BasicShapeAttributes();
            attributes.setDrawInterior(true);
        ...
        protected void setupLine(AbstractSurfaceShape shape, RenderableLayer layer, Color color, boolean closed)
        {
            ShapeAttributes attributes = new BasicShapeAttributes();
