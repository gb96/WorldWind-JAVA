...
/**
 * Demonstrates how to use the SectorSelector utility to save selected image or/and elevations in to a GeoTIFF file
 *
 * @author Lado Garakanidze
 * @version $Id: ExportImageOrElevations.java 13975 2010-10-14 00:30:42Z tgaskins $
 */
public class ExportImageOrElevations extends ApplicationTemplate
{
    public static class AppFrame extends ApplicationTemplate.AppFrame
    {
        ...
        public void enableVirtualEarthLayer()
        {
            ...
            while (iterator.hasNext())
            {
                ...
                if ("MS Virtual Earth Aerial".equals(layer.getName()))
                {
            ...
            throws IOException
        {
            ...
            elev32.setValue(AVKey.ELEVATION_UNIT, AVKey.ELEVATION_UNIT_METER);
