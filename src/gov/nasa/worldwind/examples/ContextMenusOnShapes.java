...
/**
 * Illustrates how to attach context (popup) menus to shapes. The example creates several {@link PointPlacemark}s and
 * assigns each of them a context-menu definition. When the user presses the right mouse button while the cursor is on a
 * placemark, the placemark's context menu is shown and the user may select an item in it.
 *
 * @author tag
 * @version $Id: ContextMenusOnShapes.java 13804 2010-09-15 19:36:50Z pabercrombie $
 */
