...
/**
 * @author dcollins
 * @version $Id: TiledRasterProducer.java 14056 2010-10-27 09:11:24Z garakl $
 */
public abstract class TiledRasterProducer extends AbstractDataStoreProducer
{
    ...
    protected void assembleDataSource(Object source, AVList params) throws Exception
    {
        ...
        else
        {
            ...
            this.dataRasterList.add(new ReadableDataRaster(source, params, reader, this.getCache()));
        }
    }
    ...
    protected boolean isFinalLevel(LevelSet levelSet, int levelNumber, AVList params)
    {
        ...
        if (null != o && o instanceof Integer && levelNumber >= (Integer) o)
            return true;
