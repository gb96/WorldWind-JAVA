...
/**
 * @author tag
 * @version $Id: SAR2.java 13555 2010-07-15 16:49:17Z dcollins $
 */
public class SAR2 extends JFrame
{
    ...
    protected void showGOSPortal()
    {
        ...
        if (this.gosPortalFrame.getGeodataWindow() instanceof Component)
            ((Component) this.gosPortalFrame.getGeodataWindow()).requestFocusInWindow();
    }
    ...
    private void initComponents()
    {
        ...
        JMenuBar menuBar = new JMenuBar();
        {
            ...
            //======== "File" ========
            {
                ...
                JMenuItem gosPortal = new JMenuItem();
                gosPortal.setText("Geospatial One-Stop Portal...");
                gosPortal.setMnemonic('G');
                gosPortal.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_G,
                    Toolkit.getDefaultToolkit().getMenuShortcutKeyMask()));
                gosPortal.addActionListener(new ActionListener()
                {
                    public void actionPerformed(ActionEvent event)
                    {
                        // Show the GOS portal frame.
                        showGOSPortal();
                    }
                });
                fileMenu.add(gosPortal);
        ...
        JToolBar toolBar = new JToolBar();
        {
            ...
            // == Screen Shot ==
            button = makeToolBarButton("24x24-zoom.gif", "Open Geospatial One-Stop Portal", "GOS Portal");
            button.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e)
                {
