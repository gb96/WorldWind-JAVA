 ...
 * @version $Id: GeoSymSupport.java 12524 2009-08-26 22:37:54Z tgaskins $
 */
public class GeoSymSupport
{
    ...
    protected void assembleAreaSymbolAttributes(String symbol, VPFSymbolAttributes attr)
    {
        ...
        if (geoSymAttr != null)
        {
            ...
            if (geoSymAttr.getInteriorImageSource() != null && geoSymAttr.getInteriorImageSource() instanceof String)
            {
                Object symbolSource = this.getSymbolSource((String) geoSymAttr.getInteriorImageSource());
                attr.setInteriorImageSource(symbolSource);
            }
        }
    }
