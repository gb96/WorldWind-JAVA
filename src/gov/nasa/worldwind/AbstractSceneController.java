...
/**
 * @author tag
 * @version $Id: AbstractSceneController.java 14197 2010-12-07 00:21:43Z dcollins $
 */
...
//        checkGLErrors(dc);
    ...
    protected void drawOrderedSurfaceRenderables(DrawContext dc)
    {
        ...
        // SufaceObject.render during preRendering, SurfaceObjects should not add themselves to the ordered surface
     ...
     *
     * @see {@link gov.nasa.worldwind.render.DrawContext#getOrderedSurfaceRenderables()}
     */
