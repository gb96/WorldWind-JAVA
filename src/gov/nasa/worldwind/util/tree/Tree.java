 ...
 *
 * @author pabercrombie
 * @version $Id: Tree.java 14107 2010-11-12 20:27:06Z dcollins $
 * @see TreeModel
 * @see TreeLayout
 * @see TreeListener
 * @see gov.nasa.worldwind.event.TreeEvent
 */
public interface Tree extends OrderedRenderable, AVList
{
    /**
    ...
    /**
     * Add a listener to receive tree events.
     *
