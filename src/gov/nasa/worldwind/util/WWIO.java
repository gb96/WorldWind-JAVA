...
/**
 * @author Tom Gaskins
 * @version $Id: WWIO.java 14218 2010-12-10 03:44:10Z tgaskins $
 */
...
public class WWIO
{
    ...
    /**
     * Indicates whether a {@link File} contains a specified content type.
     * <p/>
     ...
     *
     * @return true if the file contains the specified content type, false if the file does not contain the specified
     *         content type or either argument is null.
     */
    public static boolean isContentType(File file, String mimeType)
    {
        ...
        return fileSuffix.equalsIgnoreCase(typeSuffix);
    }
     ...
     *
     * @param path the string to conver to a URL.
     *
     * @return a URL for the specified object, or null if a URL could not be created.
     *
     * @see #makeURL(Object), #makeURL(Object, String)
     */
     ...
     * @return a URL for the specified object, or null if a URL could not be created.
     *
     * @see #makeURL(String), #makeURL(Object, String)
     */
     ...
     * @return a URL for the specified object, or null if a URL could not be created.
     *
     * @see #makeURL(String), #makeURL(Object)
     */
     ...
     *
     * @see #makeURL(String), #makeURL(Object), #makeURL(Object, String)
     */
