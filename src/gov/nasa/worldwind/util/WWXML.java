 ...
 *
 * @author tag
 * @version $Id: WWXML.java 14140 2010-11-21 06:43:49Z tgaskins $
 */
public class WWXML
{
     ...
     *                                  .
     */
    public static XMLEventReader openEventReaderFile(String filePath, Class c)
    {
        if (filePath == null)
        {
            String message = Logging.getMessage("nullValue.FileIsNull");
        ...
        return inputStream != null ? openEventReaderStream(inputStream) : null;
    }
     ...
     *                                  .
     */
    public static XMLEventReader openEventReaderURL(URL url)
    {
        if (url == null)
        {
            String message = Logging.getMessage("nullValue.URLIsNull");
        ...
        {
            InputStream inputStream = url.openStream();
            return openEventReaderStream(inputStream);
        }
        catch (IOException e)
        {
            String message = Logging.getMessage("generic.ExceptionAttemptingToParseXml", url.toString());
    ...
    public static XMLEventReader openEventReader(Object docSource)
    {
        ...
        if (docSource instanceof URL)
        {
            return openEventReaderURL((URL) docSource);
        }
        else if (docSource instanceof InputStream)
        {
            return openEventReaderStream((InputStream) docSource);
        }
        else if (docSource instanceof File)
        {
            return openEventReaderFile(((File) docSource).getPath(), null);
        }
        else if (docSource instanceof java.nio.ByteBuffer)
        {
            ...
            return openEventReaderStream(is);
        }
        else if (!(docSource instanceof String))
        {
            String message = Logging.getMessage("generic.UnrecognizedSourceType", docSource.toString());
        ...
        URL url = WWIO.makeURL(sourceName);
        if (url != null)
            return openEventReaderURL(url);

        return openEventReaderFile(sourceName, null);
    }
