...
public class RestorableSupport
{
    ...
    {
        if (documentElementName == null || documentElementName.length() == 0)
        {
     ...
     *                                  RestorableSupport.
     */
    public ArrayList<LatLon> getStateObjectAsLatLonList(StateObject stateObject)
    {
        if (stateObject == null)
        {
            String message = Logging.getMessage("nullValue.StateObjectIsNull");
    ...
    public ArrayList<LatLon> getStateValueAsLatLonList(StateObject context, String name)
    {
