...
/**
 * @author tag
 * @version $Id: WWUtil.java 14186 2010-12-03 09:27:07Z tgaskins $
 */
public class WWUtil
{
    /**
     ...
     * named "set" + propertyName. If it does, the method is called with the specified property value argument.
     *
     * @param parent        the object on which to set the property.
     * @param propertyName  the name of the property.
     * @param propertyValue the value to give the property.
     *
        ...
        throws NoSuchMethodException, InvocationTargetException, IllegalAccessException
    {
        ...
        Method method = parent.getClass().getMethod("set" + propertyName, new Class[] {String.class});
