 ...
 *
 * @author Tom Gaskins
 * @version $Id: LatLon.java 14138 2010-11-20 23:47:18Z tgaskins $
 */
public class LatLon
{
     ...
     * spans the two loctaions (see {@link #interpolateRhumb(double, LatLon, LatLon)}. Otherwise, this returns the
