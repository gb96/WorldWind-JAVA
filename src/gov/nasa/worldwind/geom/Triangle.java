 ...
 * @version $Id: Triangle.java 14177 2010-12-03 00:28:05Z tgaskins $
 */
...
//        return (u > 0d) && (v > 0d) && (u + v < 1d);
     ...
     * @return the list of intersections with the line and the triangle fan, or null if there are no intersections.
     */
    public static List<Intersection> intersectTriangleTypes(final Line line, Vec4[] vertices, IntBuffer indices,
        int triangleType)
    {
        if (triangleType == GL.GL_TRIANGLE_STRIP)
