...
/**
 * @author dcollins
 * @version $Id: OrbitViewInputSupport.java 12530 2009-08-29 17:55:54Z jterhorst $
 */
public class OrbitViewInputSupport
{
    ...
    public static Matrix computeTransformMatrix(Globe globe, Position center, Angle heading, Angle pitch, double zoom)
    {
        if (globe == null)
        {
        ...
        Matrix transform;
        // Zoom, heading, pitch.
        transform = OrbitViewInputSupport.computeHeadingPitchZoomTransform(heading, pitch, zoom);
        // Center position.
    ...
    protected static Matrix computeHeadingPitchZoomTransform(Angle heading, Angle pitch, double zoom)
    {
        if (heading == null)
        {
            String message = Logging.getMessage("nullValue.HeadingIsNull");
