 ...
 *
 * @author tag
 * @version $Id: KMLDoc.java 13606 2010-08-06 21:32:22Z tgaskins $
 */
public interface KMLDoc
{
     ...
     * path is resolved according to the rules of the underlying operating system. (In most such cases the operating
     * system resolves the path relative to the application's current working directory.)
     *
    ...
    /**
     * Returns an absolute path to a file indicated by a path relative to the KML file's location.
     *
     * @param path the path of the requested file.
     *
     * @return an absolute path to the file, or null if the file does not exist.
     *
