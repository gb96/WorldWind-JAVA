 ...
 *
 * @author tag
 * @version $Id: KMLFile.java 13466 2010-06-17 20:44:29Z tgaskins $
 */
public class KMLFile implements KMLDoc
{
     ...
     */
    public KMLFile(File file) throws IOException
    {
        if (file == null)
        {
    ...
    /**
     * Returns the {@link File} specifed to the constructor.
     *
