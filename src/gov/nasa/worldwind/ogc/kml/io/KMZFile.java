 ...
 *
 * @author tag
 * @version $Id: KMZFile.java 13480 2010-06-23 23:38:32Z tgaskins $
 */
public class KMZFile implements KMLDoc
{
    ...
    protected Map<String, File> files = new ConcurrentHashMap<String, File>();
    ...
    /**
     * Returns as a {@link ZipFile} the file specifed to the constructor.
     *
     ...
     *
     * @return the path to the file, or null if the entry is a directory or the temporary directory cannont be created.
     *
