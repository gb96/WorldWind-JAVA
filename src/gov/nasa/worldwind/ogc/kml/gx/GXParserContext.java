...
/**
 * @author tag
 * @version $Id: GXParserContext.java 13388 2010-05-19 17:44:46Z tgaskins $
 */
public class GXParserContext extends BasicXMLEventParserContext
{
    ...
    public static Map<QName, XMLEventParser> getDefaultParsers()
    {
        ...
        BooleanIntegerXMLEventParser booleanIntegerParser = new BooleanIntegerXMLEventParser();
        for (String s : BooleanIntegerFields)
        {
            parsers.put(new QName(ns, s), booleanIntegerParser);
        }
