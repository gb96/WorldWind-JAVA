 ...
 *
 * @author tag
 * @version $Id: KMLParserContext.java 13866 2010-09-23 19:56:15Z pabercrombie $
 */
public class KMLParserContext extends BasicXMLEventParserContext
{
    ...
    protected void initializeParsers(String ns)
    {
        ...
        this.parsers.put(new QName(ns, "Url"), new KMLNetworkLink(ns));
        ...
        this.addBooleanIntegerParsers(ns, BooleanIntegerFields);
    }
