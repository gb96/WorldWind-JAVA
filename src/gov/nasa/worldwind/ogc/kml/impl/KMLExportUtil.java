 ...
 *
 * @author tag
 * @version $Id: KMLExportUtil.java 13803 2010-09-15 19:26:44Z pabercrombie $
 */
public class KMLExportUtil
{
     ...
     *
     * @return The KML altitude mode that corresponds to {@code alitudeMode}.
     *
    ...
    public static String kmlAltitudeMode(int altitudeMode)
    {
        ...
        switch (altitudeMode)
        {
            ...
            case WorldWind.CONSTANT: // TODO: is this the right way to treat constant?
     ...
     *          if exception occurs writing XML.
     */
    private static void exportDimensionAttributes(String axes, XMLStreamWriter xmlWriter, int sizeMode, double size,
        String units)
        throws XMLStreamException
    {
        switch (sizeMode)
        {
            case Size.NATIVE_DIMENSION:
                xmlWriter.writeAttribute(axes, "-1");
                break;
            case Size.MAINTAIN_ASPECT_RATIO:
                xmlWriter.writeAttribute(axes, "0");
                break;
            case Size.EXPLICIT_DIMENSION:
