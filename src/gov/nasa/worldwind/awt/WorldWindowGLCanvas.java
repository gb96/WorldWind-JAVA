 ...
 *
 * @author Tom Gaskins
 * @version $Id: WorldWindowGLCanvas.java 14146 2010-11-23 00:39:40Z tgaskins $
 */
public class WorldWindowGLCanvas extends GLCanvas implements WorldWindow, PropertyChangeListener
{
     ...
     * resources with another <code>WorldWindowGLCanvas</code> window.
     *
     * @param shareWith a <code>WorldWindowGLCanvas</code> with which to share graphics resources. May be null, in which
    ...
    {
        super(caps, null, shareWith != null ? shareWith.getContext() : null, null);
     ...
     * <code>WorldWindowGLCanvas</code> window. The new window is created on the specified graphics device.
     *
     * @param shareWith a <code>WorldWindowGLCanvas</code> with which to share graphics resources. May be null, in which
     *                  case resources are not shared.
    ...
    {
        super(caps, null, shareWith != null ? shareWith.getContext() : null, device);
     ...
     * graphics device.
     *
     * @param shareWith    a <code>WorldWindowGLCanvas</code> with which to share graphics resources. May be null, in
