 ...
 *
 * @author dcollins
 * @version $Id: GLRuntimeCapabilities.java 12991 2010-01-09 06:30:03Z tgaskins $
 */
public class GLRuntimeCapabilities
{
    ...
    public GLRuntimeCapabilities()
    {
        ...
        // Disable vertex buffer objects by default. VBO's are slower in on Mac OS X and on some PCs with ATI graphics
        // cards. This is likely caused by conversion from double precision values to single precision values by the
        // graphics driver.
        // TODO: Investigate why VBOs reduce performance (at least in RectangularTessellator) on some platforms.
        this.isVertexBufferObjectEnabled = false;
