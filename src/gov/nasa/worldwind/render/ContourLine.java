 ...
 * @version $Id: ContourLine.java 13499 2010-06-28 20:39:06Z tgaskins $
 */
public class ContourLine implements Renderable
{
     ...
     *
     * @param viewClippingEnabled <code>true</code> if view clipping should be performed, otherwise
     * <code>false</code> (the default).
     */
    @SuppressWarnings({"UnusedDeclaration"})
     ...
     * inclusion inside the bounding sector.
     *
     * @param dc the current <code>DrawContext</code>
     * @param list the list of <code>Intersection</code> to be filtered.
     * @return the filtered list.
    ...
    /**
     * Add a set of <code>Polyline</code> objects to the contour line renderable list by connecting
     * as much as possible the segments from the given <code>Intersection</code> array.
     *
     * @param dc the current <code>DrawContext</code>.
     ...
     * @version $Id: ContourLine.java 13499 2010-06-28 20:39:06Z tgaskins $
     */
    public static class TimedExpirySupport
    {
