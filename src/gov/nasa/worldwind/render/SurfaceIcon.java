 ...
 * @version $Id: SurfaceIcon.java 13730 2010-09-08 22:55:46Z dcollins $
 */
public class SurfaceIcon extends AbstractSurfaceRenderable implements Movable
{
     ...
     *
     * @see {@link #getHeading()}
     * @see {@link #isMaintainSize()}
     */
    @Override
    public Object getStateKey(DrawContext dc)
    {
        // If the icon alwasy redraws, return a unique object that is not equivalent to any other state key.
