 ...
 * @version $Id: FrameFactory.java 11709 2009-06-17 22:40:56Z dcollins $
...
public class FrameFactory
{
     ...
     * @param cornerRadius the rounded corners radius. Set to zero for square corners.
     */
    public static void drawShapeWithLeader(DrawContext dc, String shape, double width, double height, Point leaderOffset, double leaderGapWidth, int glMode, int cornerRadius)
    {
        if (!shape.equals(SHAPE_NONE))
            drawBuffer(dc, glMode, createShapeWithLeaderBuffer(shape, width, height, leaderOffset, leaderGapWidth, cornerRadius, null));
    }
    ...
    {
        if (shape.equals(SHAPE_RECTANGLE))
            return createRoundedRectangleWithLeaderBuffer(width, height, leaderOffset, leaderGapWidth, cornerRadius, buffer);
        else if (shape.equals(SHAPE_ELLIPSE))
    ...
    private static DoubleBuffer createRoundedRectangleWithLeaderBuffer(double width, double height, Point leaderOffset, double leaderGapWidth, int cornerRadius, DoubleBuffer buffer)
    {
    ...
    private static DoubleBuffer createEllipseWithLeaderBuffer(double width, double height, Point leaderOffset, double leaderGapWidth, int steps, DoubleBuffer buffer)
    {
