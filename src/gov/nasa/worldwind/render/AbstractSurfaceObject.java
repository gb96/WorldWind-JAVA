 ...
 *
 * @author dcollins
 * @version $Id: AbstractSurfaceObject.java 14197 2010-12-07 00:21:43Z dcollins $
 */
public abstract class AbstractSurfaceObject extends AVListImpl implements SurfaceObject
{
    ...
    protected void makeOrderedPreRenderable(DrawContext dc)
    {
        ...
        // representation of this object and any other SurfaceObject on the queue, and cakks this object's preRender
     ...
     * the DrawContex has a SurfaceTileDrawContext attached under that key, this calls {@link
    ...
    protected void drawPickRepresentation(DrawContext dc)
    {
        ...
        // was not picked. This method should never be called when the list is empty, but we check anyway.
        if (this.pickTiles.isEmpty())
            return;
