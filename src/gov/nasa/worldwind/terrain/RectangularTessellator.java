...
/**
 * @author tag
 * @version $Id: RectangularTessellator.java 13987 2010-10-19 16:40:41Z tgaskins $
 */
public class RectangularTessellator extends WWObjectImpl implements Tessellator
{
    ...
    protected long updateFrequency = 1000; // milliseconds
            ...
            cache.addCacheListener(new MemoryCache.CacheListener()
            {
                public void entryRemoved(Object key, Object clientObject)
                {
                    ...
                    if (ri.bufferIdVertices != null)
                    {
                        ...
                        glc.getGL().getGL2().glDeleteBuffers(1, glBuf, 0);
                    }
                }
            });
    ...
    public RenderInfo buildVerts(DrawContext dc, RectTile tile, boolean makeSkirts)
    {
        ...
        {
            verts = Buffers.newDirectDoubleBuffer(numVertices * 3);
        }
        else
        {
        ...
        Double exaggeratedMinElevation = makeSkirts ? globe.getMinElevation() * verticalExaggeration : null;
    ...
    protected long render(DrawContext dc, RectTile tile, int numTextureUnits)
    {
        ...
        try
        {
            ...
            if (dc.getGLRuntimeCapabilities().isUseVertexBufferObject())
            {
                ...
                gl.glVertexPointer(3, GL2GL3.GL_DOUBLE, 0, 0);
                ...
                for (int i = 0; i < numTextureUnits; i++)
                {
                    ...
                    gl.glTexCoordPointer(2, GL2GL3.GL_DOUBLE, 0, 0);
                }
