 ...
 *
 * @author tag
 * @version $Id: BasicTiledImageLayerBulkDownloader.java 13979 2010-10-15 17:33:42Z tgaskins $
 */
...
//    }
    ...
    protected synchronized void submitMissingTilesRequests() throws InterruptedException
    {
        ...
        while (this.missingTiles.size() > i && rs.isAvailable())
        {
            ...
            this.layer.retrieveRemoteTexture(tile, new BulkDownloadPostProcessor(tile, this.layer, this.fileStore));
            i++;
        }
    }
