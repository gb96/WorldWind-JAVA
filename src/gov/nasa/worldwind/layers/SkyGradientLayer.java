 ...
 * @version $Id: SkyGradientLayer.java 13704 2010-09-03 07:16:58Z tgaskins $
 */
public class SkyGradientLayer extends AbstractLayer
{
    ...
    protected boolean isValid(DrawContext dc)
    {
        ...
        return this.glListId != -1 && Math.abs(this.lastRebuildHorizon - dc.getView().getFarClipDistance()) <= 100;
    }
