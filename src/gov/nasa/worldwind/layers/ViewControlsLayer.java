 ...
 * @version $Id: ViewControlsLayer.java 13909 2010-09-30 06:33:58Z pabercrombie $
 * @see ViewControlsSelectListener
 */
public class ViewControlsLayer extends RenderableLayer
{
    private final static String IMAGE_PAN = "images/view-pan-64x64.png";
    private final static String IMAGE_LOOK = "images/view-look-64x64.png";
    private final static String IMAGE_HEADING_LEFT = "images/view-heading-left-32x32.png";
    private final static String IMAGE_HEADING_RIGHT = "images/view-heading-right-32x32.png";
    private final static String IMAGE_ZOOM_IN = "images/view-zoom-in-32x32.png";
    private final static String IMAGE_ZOOM_OUT = "images/view-zoom-out-32x32.png";
    private final static String IMAGE_PITCH_UP = "images/view-pitch-up-32x32.png";
    private final static String IMAGE_PITCH_DOWN = "images/view-pitch-down-32x32.png";
    private final static String IMAGE_FOV_NARROW = "images/view-fov-narrow-32x32.png";
    private final static String IMAGE_FOV_WIDE = "images/view-fov-wide-32x32.png";
    private final static String IMAGE_VE_UP = "images/view-elevation-up-32x32.png";
    private final static String IMAGE_VE_DOWN = "images/view-elevation-down-32x32.png";
    ...
    private String layout = AVKey.HORIZONTAL;
    ...
    private int panSize = 64;
    private boolean initialized = false;
    private Rectangle referenceViewport;

    private boolean showPanControls = true;
    private boolean showLookControls = false;
    private boolean showZoomControls = true;
    private boolean showHeadingControls = true;
    private boolean showPitchControls = true;
    private boolean showFovControls = false;
    private boolean showVeControls = true;
     ...
     *
     * @param position the desired view controls position.
     */
    public void setPosition(String position) // TODO: Change name to setScreenPosition?
    {
        if (position == null)
        {
    ...
    public void highlight(Object o) // TODO: Maybe extract to a Highlightable interface
    {
        // Manage highlighting of controls.
        if (this.currentControl == o)
        ...
        if (o != null && o instanceof ScreenAnnotation)
        {
            this.currentControl = (ScreenAnnotation) o;
     ...
     * to either the location center if not null, or the screen position.
     *
