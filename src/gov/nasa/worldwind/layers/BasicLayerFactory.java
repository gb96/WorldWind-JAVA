 ...
 *
 * @author dcollins
 * @version $Id: BasicLayerFactory.java 14140 2010-11-21 06:43:49Z tgaskins $
 */
public class BasicLayerFactory extends BasicFactory
{
    ...
    protected Layer createTiledImageLayer(Element domElement, AVList params)
    {
        ...
        {
            layer = this.createLocalRasterLayer(domElement, params);
        }
        else
        {
...
//        System.out.println(name);
    ...
    protected Layer createLocalRasterLayer(Element domElement, AVList params)
    {
        BasicTiledImageLayer layer = new BasicTiledImageLayer(domElement, params);

        final FileStore fs = layer.getDataFileStore();
        if (null == fs)
        {
        ...
        RetrieverFactory retrieverFactory = new RetrieverFactory()
        {
            ...
            public Retriever createRetriever(AVList tileParams, RetrievalPostProcessor postProcessor)
            {
                ...
                this.copyValues(rasterServerParams, retriever, new String[] {
                    ...
                    AVKey.FILE_STORE, AVKey.IMAGE_FORMAT, AVKey.FORMAT_SUFFIX,
//                        AVKey.TILE_HEIGHT, AVKey.TILE_WIDTH,
                });
        ...
        layer.setValue(AVKey.RETRIEVER_FACTORY_LOCAL, retrieverFactory);

        return layer;
//        return new BasicTiledImageLayer(domElement, params);
    }
}
