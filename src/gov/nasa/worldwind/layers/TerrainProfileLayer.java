 ...
 * @version $Id: TerrainProfileLayer.java 13499 2010-06-28 20:39:06Z tgaskins $
 */
...
//            this.expirySupport.updateExpiryCriteria(dc);
    ...
    private void drawLabel(DrawContext dc, String text, Vec4 screenPoint, int align)
    {
...
//            this.wwd.getModel().getGlobe().getElevationModel().addPropertyChangeListener(this);
    ...
    private Position computeViewCenterPosition(DrawContext dc)
    {
