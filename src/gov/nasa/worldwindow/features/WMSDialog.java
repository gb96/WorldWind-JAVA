...
/**
 * @author tag
 * @version $Id: WMSDialog.java 13825 2010-09-18 00:18:35Z tgaskins $
 */
public class WMSDialog extends AbstractFeatureDialog
{
    ...
    public void initialize(final Controller controller)
    {
        ...
        JButton deleteButton = new JButton(ImageLibrary.getIcon("gov/nasa/worldwindow/images/delete-20x20.png"));
