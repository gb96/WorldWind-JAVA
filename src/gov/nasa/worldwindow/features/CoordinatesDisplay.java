...
import gov.nasa.worldwindow.util.WWOUnitsFormat;
...
/**
 * @author tag
 * @version $Id: CoordinatesDisplay.java 13909 2010-09-30 06:33:58Z pabercrombie $
 */
public class CoordinatesDisplay extends AbstractOnDemandLayerFeature
{
    ...
    {
        super("Coordinates", Constants.FEATURE_COORDINATES_DISPLAY, "gov/nasa/worldwindow/images/coordinates-64x64.png",
            null, registry);
    }
    ...
    protected Layer doCreateLayer()
    {
        ...
        attrs.setFrameShape(FrameFactory.SHAPE_NONE);
